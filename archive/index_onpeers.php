...
<body>
  <div id="default_chatroom_greet">
    <h1>Hello World!</h1>
    <?php
      echo "Welcome to ".$SERVER_IP_ADDRESS."!<br>";
    ?>
    <div id="time"></div>
    <?php 
      echo "Your IP is ".$USER_IP_ADDRESS."<br>";
    ?>
  </div>
  <iframe name="nfresh" style="display:none;"></iframe>
  <div id="users_onscreen" hidden></div>
  <p id="chatbox_actions">
    Say Something or Hear from Other Peers!<br>
  ...
  <form method="post" id="form1" name="form1" target="nfresh">
    ...
    <textarea onfocus="TxtHereOnFocus()" onblur="TxtHereOnBlur()" id="txthere" name="txthere" rows="8" cols="80" value="" maxlength="9001"></textarea>
  </form>
  <?php
    //Posting
...
//
  ...
  <form method="post" id="formaxis" name="formaxis" target="nfresh" style="display:inline;">
    ...
    <?php
      echo "<div id='random_tips' style='display:inline;'>".$PROTIPS[$RAND_TIP]."</div>";
    ?>
  <?php
//AXIS MOVEMENT
